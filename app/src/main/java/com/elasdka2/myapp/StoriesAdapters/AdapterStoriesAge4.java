...
public class AdapterStoriesAge4 extends RecyclerView.Adapter<AdapterStoriesAge4.ViewHolder> {
    ...
    public AdapterStoriesAge4(Context context, List<String> data, Context mcontext) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (position == 0){
                    i.putExtra("Video_URL","QFVOIXR8soQ");
                    i.putExtra("Age",4);
                    mcontext.startActivity(i);
                    ((Activity)mcontext).finish();
                }else if (position == 1){
                    i.putExtra("Video_URL","0-NhjfJ_RZI");
                    i.putExtra("Age",4);
                    mcontext.startActivity(i);
                    ((Activity)mcontext).finish();
                }else if (position == 2){
                    i.putExtra("Video_URL","d7SGmh7Qs8o");
                    i.putExtra("Age",4);
                    mcontext.startActivity(i);
                    ((Activity)mcontext).finish();
                }
                    ...
                    i.putExtra("Video_URL","O_3--2YOpJ0");
                    i.putExtra("Age",4);
                    mcontext.startActivity(i);
                    ((Activity)mcontext).finish();
                }
