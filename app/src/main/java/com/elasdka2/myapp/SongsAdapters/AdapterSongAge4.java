...
public class AdapterSongAge4 extends RecyclerView.Adapter<AdapterSongAge4.ViewHolder> {
    ...
    public AdapterSongAge4(Context context, List<String> data, Context mcontext) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (position == 0){
                    i.putExtra("Video_URL","75NQK-Sm1YY");
                    i.putExtra("Age",4);
                    ...
                    i.putExtra("Video_URL","BELlZKpi1Zs");
                    i.putExtra("Age",4);
                    mcontext.startActivity(i);
                }else if (position == 3){
                    i.putExtra("Video_URL","8ZjpI6fgYSY");
                    i.putExtra("Age",4);
                    mcontext.startActivity(i);
                }
