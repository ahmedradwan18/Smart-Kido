...
public class AdapterSongAge3 extends RecyclerView.Adapter<AdapterSongAge3.ViewHolder> {
    ...
    public AdapterSongAge3(Context context, List<String> data, Context mcontext) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (position == 0){
                    i.putExtra("Video_URL","JrtPRQO9pu4");
                    i.putExtra("Age",3);
                    mcontext.startActivity(i);
                }else if (position == 1){
                    i.putExtra("Video_URL","5h8NDskFLkU");
                    i.putExtra("Age",3);
                    mcontext.startActivity(i);
                }else if (position == 2){
                    i.putExtra("Video_URL","ABEVNHqmbJ4");
                    i.putExtra("Age",3);
                    mcontext.startActivity(i);
                }else if (position == 3){
                    i.putExtra("Video_URL","5ryLkX1G840");
                    i.putExtra("Age",3);
                    mcontext.startActivity(i);
                }
            }
