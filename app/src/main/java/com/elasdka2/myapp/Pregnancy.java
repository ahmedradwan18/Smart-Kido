...
public class Pregnancy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pregnancy_act);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(Pregnancy.this, Categories.class));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id==R.id.logOut){
           // Toast.makeText(this, "u r logged out", Toast.LENGTH_SHORT).show();
